## reference
# https://www.youtube.com/watch?v=sIOMDu6MXJQ     # 10: 42
# https://www.holidayfrancedirect.co.uk/
# to implement pagination, we need to find some regularity between url clicking several page numbers
# for example, in case of zalando page https://en.zalando.de/clothing/?p=2 , p=2 means page number and there is regularity between pages as well
